  ...
  return (
    // <div className="h-full flex flex-col">
      ...
      <TracePageBody width="wide"  >
        {!showAgents ? (
         <div className={"w-[70%] ml-[15%] mt-[3rem] mb-[3rem] space-y-6"}>
           <Card style={{background:"white"}}>
             ...
             <CardContent className="space-y-6">
               ...
               >
                 ...
                 <p className="text-lg font-medium text-[#45556B]">
                   Drag and drop files here, or click to browse
                 </p>
                 <p className="text-sm text-muted-foreground mt-2 text-[#45556B]">
                   Supports PDF, Word, Excel, CSV, and text files
                 </p>
               </div>

               {files.length > 0 && (
                   <div className="space-y-3 text-[#45556B]">
               ...
               <div className="flex gap-3">
                 <Button
                     ...
                     className="flex-1 bg-[#1E49E2] hover:bg-[#00338D] text-[white]"
                     // style={{ background: "linear-gradient(90deg, #7213EA 0%, #0C233C 50%)" }}
                 ...
                 {/*    className={"flex-1 border-[#1E49E2] bg-white hover:bg-[#00338D] text-[1E49E2]"}*/}
                 {/*>*/}
                 {/*  Clear*/}
                 {/*</Button>*/}
               </div>
