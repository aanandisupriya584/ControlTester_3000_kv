    ...
    <section className="mb-9 grid gap-5 md:grid-cols-6" data-risk-assessment-feature-cards="true">
      {cards.map((card) => (
        ...
        >
          ...
          <div className="min-h-[45px] max-h-[45px]">
...
export default function RiskAssessmentOverview(props: RiskAssessmentOverviewProps) {
  return (
    <>
      <RiskAssessmentFeatureCards {...props} />
      <HowItWorks
        defaultOpen
        steps={[
          {
